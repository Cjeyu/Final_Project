            ...
            {users.length > 0 ? (
              <div>
                ...
                <div className="admin-pagination">
                  <button
                    onClick={() => handlePageChange(setCurrentUsersPage, currentUsersPage, Math.ceil(users.length / usersPerPage), -1)}
                  ...
                  <button
                    onClick={() => handlePageChange(setCurrentUsersPage, currentUsersPage, Math.ceil(users.length / usersPerPage), 1)}
                    disabled={currentUsersPage === Math.ceil(users.length / usersPerPage)}
                  >
                    다음 &gt;
                  </button>
                </div>
          ...
          <div className="admin-list-container">
            ...
            {posts.length > 0 ? (
              <div>
                ...
                <div className="admin-pagination">
                  <button
                    onClick={() => handlePageChange(setCurrentPostsPage, currentPostsPage, Math.ceil(posts.length / postsPerPage), -1)}
                  ...
                  <button
                    onClick={() => handlePageChange(setCurrentPostsPage, currentPostsPage, Math.ceil(posts.length / postsPerPage), 1)}
                    disabled={currentPostsPage === Math.ceil(posts.length / postsPerPage)}
                  >
                    다음 &gt;
                  </button>
                </div>
